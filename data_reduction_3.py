...
if __name__ == "__main__":
    ...
    X_reduct = _X[ind]
    y_reduct = _y[ind]
    pickle.dump(ind, open("train_reduct_ind_scaled_half_3.data", "wb"))
    pickle.dump(X_reduct, open("train_reduct_scaled_half_3.data", "wb"))
    pickle.dump(y_reduct, open("train_labels_reduct_scaled_half_3.data", "wb"))
    print("done.!")
